...
class TestParseRating:
    ...
    def test_chinese_label_and_punctuation(self):
        assert parse_rating("**评级：Underweight（减持/低配）**") == "Underweight"

    def test_chinese_only_underweight(self):
        assert parse_rating("评级：减持/低配\n目标仓位降至2%。") == "Underweight"

    def test_irrelevant_decision_heading_does_not_mask_rating(self):
