...
- Keep the repository private until the initial CI, CodeQL, dependency review, Gitleaks, and license checks pass. Re-run secret scanning after changing visibility to public.
